// Package rendura_test_helpers provides helper functions for writing unit tests.
...
func AssertSurfaceEqual[T comparable](t *testing.T, expected, actual rendura.Surface[T]) (equal bool) {
	t.Helper()
...
func AssertSpriteEqual(t *testing.T, expected, actual rendura.Sprite) {
	t.Helper()
