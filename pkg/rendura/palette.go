...
import (
	...
	"github.com/bauerceptor/rendura/internal"
	rendura_math "github.com/bauerceptor/rendura/rendura_math"
)
...
func FromRGBf(r, g, b float64) RGB {
	red := rendura_math.Clamp(r*255, 0, 255)
	green := rendura_math.Clamp(g*255, 0, 255)
	blue := rendura_math.Clamp(b*255, 0, 255)
