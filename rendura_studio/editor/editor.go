...
const (
	...
	// Handle input with rendura_key, rendura_pad, rendura_mouse
	
	// Example: Exit with Escape
	// if rendura_key.Duration(rendura_key.Escape) > 0 {
	//     os.Exit(0)
	// }
}`
